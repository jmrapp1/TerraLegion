...
public class CraftingRecipes {
	...
	public CraftingRecipes() {
		recipes.put(BlockType.TORCH.getId(), new CraftingRecipe(ItemStack.getItemStack(ItemManager.getInstance().getItem(BlockType.TORCH), 3), ItemStack.getItemStack(ItemManager.getInstance().getItem(BlockType.COAL), 1), ItemStack.getItemStack(ItemManager.getInstance().getItem(BlockType.WOOD), 2)));
		recipes.put(ItemType.WOODEN_PICKAXE.getId(), new CraftingRecipe(ItemStack.getItemStack(ItemManager.getInstance().getItem(ItemType.WOODEN_PICKAXE), 1), ItemStack.getItemStack(ItemManager.getInstance().getItem(BlockType.WOOD), 3), ItemStack.getItemStack(ItemManager.getInstance().getItem(BlockType.STONE), 5)));
	}
