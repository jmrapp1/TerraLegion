...
import com.jmrapp.terralegion.game.world.entity.behaviors.movement.models.MoveLeftModel;

/** ExecutionAction class created from MMPM action MoveLeftAction. */
public class MoveLeftAction extends jbt.execution.task.leaf.action.ExecutionAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of MoveLeftAction that is able to run a
	 * com.
	 * jmrapp.terralegion.game.world.entity.behaviors.movement.models.MoveLeftAction.
	 * 
	 * @param entity
	...
	protected void internalSpawn() {
		...
		System.out.println("Move Left spawned");
