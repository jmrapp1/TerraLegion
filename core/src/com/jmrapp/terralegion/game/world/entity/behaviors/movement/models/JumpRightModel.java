...
import com.jmrapp.terralegion.game.world.entity.behaviors.movement.executions.JumpRightAction;

/** ModelAction class created from MMPM action JumpRightAction. */
public class JumpRightModel extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of JumpRightAction.
	 * 
	 * @param entity
	 ...
	 *            retrieved from.
	 */
	public JumpRightModel(jbt.model.core.ModelTask guard, Object entity,
                          String entityLoc) {
		super(guard);
		this.entity = entity;
	 ...
	 * .JumpRightAction task that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new JumpRightAction(
