...
import com.jmrapp.terralegion.game.world.entity.behaviors.movement.executions.CanJumpAction;

/** ModelCondition class created from MMPM condition CanJumpAction. */
public class CanJumpModel extends jbt.model.task.leaf.condition.ModelCondition {
	/**
	...
	/**
	 * Constructor. Constructs an instance of CanJumpAction.
	 * 
	 * @param entity
	 ...
	 */
	public CanJumpModel(jbt.model.core.ModelTask guard, Object entity,
	 ...
	 * .CanJumpAction task that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new CanJumpAction(
