...
public abstract class FriendlyEntity extends LivingEntity {
	...
	public FriendlyEntity(Drawable drawable, float x, float y, BodyType bodyType, float speed, float maxHealth, float health, float jumpVelocity, EntityMind entityMind) {
		super(drawable, x, y, bodyType, speed, maxHealth, health, jumpVelocity, entityMind);
	}
