...
import com.jmrapp.terralegion.game.world.entity.behaviors.movement.executions.MoveRightAction;

/** ModelAction class created from MMPM action MoveRightAction. */
public class MoveRightModel extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of MoveRightAction.
	 * 
	 * @param entity
	 ...
	 *            retrieved from.
	 */
	public MoveRightModel(jbt.model.core.ModelTask guard, Object entity,
						  String entityLoc) {
		super(guard);
		this.entity = entity;
	 ...
	 * .MoveRightAction task that is able to run this task.
	 */
