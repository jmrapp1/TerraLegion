...
public class ItemManager {
	...
	private ItemManager() {
		...
		items.put(ItemType.FISH.getId(), new FishItem(ItemType.FISH.getId(), ItemType.FISH_COOKED, ItemCategory.MISC, "Fish", ResourceManager.getInstance().getDrawable("fish"), 64, 1, 128));
